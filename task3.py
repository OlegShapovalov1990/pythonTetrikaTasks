def appearance(intervals: dict[str, list[int]]) -> int:
    ...
    for i in range(0, len(pupil_intervals), 2):
        ...
        total_time += intersect(lesson_start, lesson_end, pupil_start, pupil_end)

    for i in range(0, len(tutor_intervals), 2):
        tutor_start = tutor_intervals[i]
        tutor_end = tutor_intervals[i + 1]
        total_time += intersect(lesson_start, lesson_end, tutor_start, tutor_end)
